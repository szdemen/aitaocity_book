...
<div class="project_list">
		...
		<div style="background-color: #BDD500;    color: #FFFFFF;    font-weight: bold;    margin-bottom: 15px;    padding: 5px;">以下是搜索关键词: <span style="color:#666"><?php echo $_GET["kw"];?></span> 的结果, 共计<?php echo count($list_search); ?>个</div>

		<ul>
        		<?php if(!empty($list_search)){ 
							 foreach($list_search as $key_n => $value_n) {
				?>
        		<li>
